        ...
        <>
            { card && (   
                ...
                <motion.div 
                    ...
                    key={card.id}
                    className='flex sm:w-[16rem] w-full sm:h-fit h-fit rounded-[10px] justify-around shadow-2xl sm:pb-8 pb-9 pt-6 px-5 bg-black bg-opacity-20 hover:bg-gradient-to-br hover:from-green-400/20 hover:via-indigo-500/20 hover:to-pink-600/20 
