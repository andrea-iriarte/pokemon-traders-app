  ...
  return (
    ...
    <header className='h-[3rem] bg-black  bg-opacity-0 flex flex-col gap-2 md:gap-0 justify-between items-center w-full  md:flex-row  mb-[4rem] md:mb-4'>
        ...
        <form action="" className='relative'>
            <input type="text" className='rounded-2xl bg-transparent border-2 border-opacity-10 border-green-300/50 w-[24rem] placeholder:text-green-300/40 placeholder:text-sm px-8 placeholder:font-light text-green-200/60 py-1 focus:border-purple-300/50 '
