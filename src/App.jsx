...
const App = () => {
  ...
  return (
    <div className='w-full h-[100vh] overflow-auto bg-gradient-to-b  via-purple-900 from-pink-900 to-black flex  justify-items-start flex-wrap pb-[4rem]'>
      <div className='h-[5rem] bg-black flex items-center w-full p-10'>
        <h1 className='text-center text-4xl text-transparent bg-clip-text bg-gradient-to-r from-pink-400  
